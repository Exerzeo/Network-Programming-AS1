...
public String resultRPS1(int a,int b,String c,String d) {
	if (a==b) {
		result="Draw";
	}else if(a==1&b==2) {
		
		result= d+" Wins. Rock vs Paper";
		
	}else if(a==1&b==3) {
		
		result= c+" Wins. Rock vs Scissor";
		
	}else if(a==3&b==2) {
		
		result= c+" Wins. Scissor vs Paper";
		
	}else if(a==3&b==1) {
		
		result= d+" Wins. Scissor vs Rock";
		
	}else if(a==2&b==1) {
		
		result= c+" Wins. Paper vs Rock";
		
	}else if(a==2&b==3) {
		
		result= d+" Wins. Scissor vs Paper";
